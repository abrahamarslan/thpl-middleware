...
from app.modules.taxes.api import router as zoho_taxes_router
...
from app.modules.zoho_currencies.api import router as zoho_currencies_router
...
api_router.include_router(zoho_currencies_router, prefix="/zoho/currencies", tags=["zoho:currencies"])
api_router.include_router(zoho_taxes_router, prefix="/zoho/taxes", tags=["zoho:taxes"])
